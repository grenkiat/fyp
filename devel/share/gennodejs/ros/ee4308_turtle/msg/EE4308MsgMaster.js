...
class EE4308MsgMaster {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EE4308MsgMaster(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new EE4308MsgMaster(null);
...
module.exports = EE4308MsgMaster;
